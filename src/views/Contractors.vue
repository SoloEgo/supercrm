<template>
  <div class="displayContentBlock">
    <div class="page-title">
      <div class="pahe-header"><h3>Сontractor</h3></div>
      <div class="page-controls">
        ...
        <button class="btn btn-sm btn-primary" @click="openModalCreateContr">
          <i class="bi btn-sm bi-plus-square"></i> New contractor</button>
      </div>
    </div>
    <section>
      ...
      <div class="empty-results-holder" v-else-if="!contractors.length">
        <div class="empty-result">
          There are no new contractors.
          <button class="btn btn-sm primary-btn">Add new contractor</button>
        </div>
      </div>
